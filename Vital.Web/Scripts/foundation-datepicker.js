...
!function ($) {
    ...
    var dates = $.fn.fdatepicker.dates = {
        ...
        el: {
            ...
            daysShort: ["ÎšÏ…Ï", "Î”ÎµÏ…", "Î¤ÏÎ¯", "Î¤ÎµÏ„", "Î Î­Î¼", "Î Î±Ï", "Î£Î¬Î²", "ÎšÏ…Ï"],
            daysMin: ["ÎšÏ…", "Î”Îµ", "Î¤Ï", "Î¤Îµ", "Î Î­", "Î Î±", "Î£Î¬", "ÎšÏ…"],
            ...
            monthsShort: ["Î™Î±Î½", "Î¦ÎµÎ²", "ÎœÎ±Ï", "Î‘Ï€Ï", "ÎœÎ±ÏŠ", "Î™Î¿Ï…", "Î™Î¿Ï…", "Î‘Ï…Î³", "Î£ÎµÏ€", "ÎŸÎºÏ„", "ÎÎ¿Îµ", "Î”ÎµÎº"],
            today: "Î£Î®Î¼ÎµÏÎ±"
        },
        uk: {
            days: ["ÐŸÐ¾Ð½ÐµÐ´iÐ»Ð¾Ðº ", "Ð’iÐ²Ñ‚Ð¾Ñ€Ð¾Ðº ", "Ð¡ÐµÑ€ÐµÐ´Ð° ", "Ð§ÐµÑ‚Ð²ÐµÑ€ ", "ÐŸ'ÑÑ‚Ð½Ð¸Ñ†Ñ ", "Ð¡ÑƒÐ±Ð¾Ñ‚Ð° ", "ÐÐµÐ´iÐ»Ñ"],
            daysShort: ["ÐŸÐ½Ð´", "Ð’Ñ‚Ñ€", "Ð¡Ñ€Ð´", "Ð§Ñ‚Ð²", "ÐŸÑ‚Ð½", "Ð¡Ð±Ñ‚", "ÐÐ´Ð»"],
            daysMin: ["ÐŸÐ½", "Ð’Ñ‚", "Ð¡Ñ€", "Ð§Ñ‚", "ÐŸÑ‚", "Ð¡Ð±", "ÐÐ´"],
            ...
            monthsShort: ["Ð¡iÑ‡", "Ð›ÑŽÑ‚", "Ð‘ÐµÑ€", "ÐšÐ²iÑ‚", "Ð¢Ñ€Ð°Ð²", "Ð§ÐµÑ€Ð²", "Ð›Ð¸Ð¿", "Ð¡ÐµÑ€Ð¿", "Ð’ÐµÑ€", "Ð–Ð¾Ð²Ñ‚", "Ð›Ð¸ÑÑ‚", "Ð“Ñ€ÑƒÐ´"],
