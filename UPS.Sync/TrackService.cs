...
namespace UPS.Sync
{
    ...
    {
        public static List<TrackingResultModel> Search(string trackingNumbers)
        {
            ...
            foreach (var trackingNumber in trackingNumberList)
            {
                ...
                try
                {
                    TrackService.TrackService track = new TrackService.TrackService();
        ...
        public static TrackingResultModel SearchInquiry(string trackingNumbers)
        {
            trackingNumbers = trackingNumbers.Trim();
            var result = new TrackingResultModel();
        ...
        public static List<TrackingModel> GetInformation(string trackingNumbers)
        {
            try
            {
                trackingNumbers = trackingNumbers.Trim();
